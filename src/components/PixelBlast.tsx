...
const PixelBlast: React.FC<PixelBlastProps> = ({
  ...
  useEffect(() => {
    ...
    if (mustReinit) {
      ...
      const mapToPixels = (e: PointerEvent) => {
        ...
        const fyFlipped = container.height - fy;
      ...
      const onPointerDown = (e: PointerEvent) => {
        ...
        threeRef.current.uniforms.uClickTimes.value[ix] =
          threeRef.current.uniforms.uTime.value;
      ...
      const onPointerMove = (e: PointerEvent) => {
        ...
        threeRef.current.touch.addTouch({
          x: fx / w,
          y: fy / h,
        });
      };
  ...
  return (
    <div
      ref={containerRef}
      className={`w-full h-full absolute z-0 top-0 left-0 overflow-hidden ${className ?? ""}`}
      style={style}
